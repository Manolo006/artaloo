      ...
      <section className="section hero hero-alt">
        <div className="section-inner">
          ...
          <p className="section-subtitle">
            Artalo è una startup ideata e promossa da Martina Troiano: un
            progetto che unisce arte, artigianato, sostenibilità e attivismo
            ambientale.
          </p>
      ...
      <section className="section">
        <div className="section-inner split">
          <article className="manifesto chi-siamo-block">
            ...
            <p className="section-subtitle" style={{ maxWidth: "none", whiteSpace: "pre-line" }}>
              {`L'esigenza del progetto nasce dalla necessità di ridurre la quantità di rifiuti non riciclabili, il bisogno è quindi di potenziare la capacità e rafforzare l'economia circolare attraverso Innovazione, Ricerca, Riparazione e soprattutto Riutilizzo.

Un progetto in collaborazione con le regione ed enti privati locali, volto a dare vita ad esempi di innovazione e attenzione al recupero. Un vero e proprio centro di sensibilizzazione, di arte e condivisione.

Un centro di riciclo creativo, che mette in comunicazione gli enti interessati creando un circuito che va a sostegno dell'alleggerimento della quantità di rifiuti da smaltire e alla sensibilizzazione rispetto alle problematiche ambientali sia del cittadino che delle scolaresche coinvolte in workshop ed eventi.`}
            </p>
          </article>
      ...
      <section className="section">
        <div className="section-inner split">
          <article className="manifesto chi-siamo-block">
            ...
            <p className="section-subtitle" style={{ maxWidth: "none", whiteSpace: "pre-line" }}>
              {`L'obiettivo del progetto è quello di alleggerire la quantità di rifiuti non riciclabili, coadiuvare in un circuito, dove ogni attore nell'ambito del trasloco e non solo, possa collaborare con responsabilità affinché il materiale di scarto sia ridotto al minimo. Una sede di attività formative, work shop, seminari ed eventi per la diffusione di buone pratiche di sostenibilità ambientale e di economia circolare, che può contare sull’impegno quotidiano di ITER e sulla collaborazione e il lavoro di tante persone, enti e istituzioni. Attraverso la riduzione dell’impiego di risorse, del degrado e dell’inquinamento nell’intero ciclo produttivo.

Artalo intende promuovere un nuovo modello di sviluppo sostenibile e si propone di diventare punto di riferimento per le giovani generazioni, in sintonia con la grande attenzione del momento attuale rispetto alla difesa del Pianeta.

Per una crescita sostenibile, finalizzata alla sostenibilità economica, sociale, ambientale e territoriale
