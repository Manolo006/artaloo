...
const COOKIE_CONSENT_KEY = "artalo-cookie-consent";
...
export default function CookieBanner() {
  ...
  return (
    <div className="cookie-banner" role="dialog" aria-live="polite" aria-label="Informativa cookie">
      <div className="cookie-banner-inner">
        ...
        <h5 className="cookie-banner-title">La tua privacy è importante per noi</h5>

        <p className="cookie-banner-text">
          Trattiamo i tuoi dati personali per misurare e migliorare i nostri siti e servizi, per
          supportare le nostre campagne e per offrirti contenuti personalizzati.
          <br />
          Per maggiori informazioni consulta la nostra{" "}
          <Link className="cookie-banner-link" href="/privacy">
